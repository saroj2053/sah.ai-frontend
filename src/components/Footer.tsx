...
const Footer: React.FC = () => {
  return (
    <section className="mt-6">
      <footer className="footer has-background-link is-flex is-justify-content-center py-5">
        <div className="content has-text-centered">
          ...
          <p className="subtitle is-6">
            <strong>SahAI</strong> &copy; {new Date().getFullYear()}. All rights
            reserved.
          </p>
          <p className="subtitle is-6">Made with ❤️ by SahAI Team</p>
        </div>
      </footer>
    </section>
  );
